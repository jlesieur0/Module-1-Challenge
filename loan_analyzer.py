...
average_loan_costs = total_loan_costs / length_loan_costs
print(average_loan_costs)
...
if present_value >= loan["loan_price"]:
    print("Great Deal! You should take this loan.")
else:
    print("Not a good deal! You should not take this loan.")
